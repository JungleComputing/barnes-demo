/* $Id: Body.java 6051 2007-08-08 15:25:59Z rob $ */
...
/*strictfp*/ public final class Body implements Cloneable, Comparable, Serializable {
    ...
    public void computeNewPosition(boolean useOldAcc,
        ...
        */
        ...
        // Somewhat different version, easier to revert.
        vel_x += acc_x * params.DT;
        vel_y += acc_y * params.DT;
        vel_z += acc_z * params.DT;

        pos_x += vel_x * params.DT;
        pos_y += vel_y * params.DT;
        pos_z += vel_z * params.DT;
    }

    // Used when computing backwards ...
    public void computeOldPosition(boolean firstIter, boolean lastIter,
            double acc_x, double acc_y, double acc_z, RunParameters params) {
        if (! firstIter) {
            vel_x -= acc_x * params.DT;
            vel_y -= acc_y * params.DT;
    ...
    // End of "Used when computing backwards".
