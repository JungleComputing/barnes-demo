/* $Id: BarnesHut.java 11903 2010-03-25 09:29:28Z ceriel $ */
...
/* strictfp */final class BarnesHut extends SatinObject implements
    ...
    private static int dump_iters = 10000000;
    ...
    BarnesHut(Reader r, RunParameters params) throws IOException {
        ...
        this.params = new RunParameters(params.THETA, params.DT, params.SOFT,
            ...
            params.ITERATIONS - (params.REVERSED ? 1 : 0), params.IMPLEMENTATION, params.REVERSED);
    ...
    private void dump(int iteration) {
        try {
            BufferedWriter w = new BufferedWriter(new FileWriter(dump_file + iteration));
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            if (argv[i].equals("-debug")) {
                ...
                impl = IMPL_FULLTREE;
            } else if (argv[i].equals("-reversed")) {
                reversed = true;
